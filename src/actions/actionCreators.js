...
export const deleteService = async (dispatch, id, loadSetter) => {
  loadSetter(true);
  try {
...
export const getServiceById = async (dispatch, id) => {
...
export const postServiceDetails = async (dispatch, data) => {
